...
Metadata:
    <font size="17"><b>Button#: </b></font>Defines what button the tag will activate
    <font size="17"><b>Delay#: </b></font>Amount of time in seconds that the tag will wait to take effect]]
            },
        },
        _Hide = {
            _nameStub = "_Hide",
...
Metadata:
    <font size="17"><b>Button#: </b></font>Defines what button the tag will activate
    <font size="17"><b>Delay#: </b></font>Amount of time in seconds that the tag will wait to take effect
    <font size="17"><b>SoundID#: </b></font>Asset ID of the desired sound. To edit the sound further, use the Properties widget.]]
            },
        },
        _Explode = {
            _nameStub = "_Explode",
...
Metadata:
    <font size="17"><b>Speed: </b></font>Speed in studs per second that the player will move on the wallrun. <20 is slower than your walkspeed.
    <font size="17"><b>Momentum: </b></font>a scalar value that determines how much speed the player will carry off of the wallrun into the air.]]
            },
        },
        _WallJump = {
...
<font size="17"><font color = "rgb(0, 143, 156)"><b>Water: </b></font></font> -8 oxygen/sec
<font size="17"><font color = "rgb(0, 255, 0)"><b>Acid: </b></font></font> -30 oxygen/sec
<font size="17"><font color = "rgb(255, 0, 0)"><b>Lava: </b></font></font> Instant death

You can specify the oxygen depletion, default color, and splash sound with custom liquids.

Metadata:
    <font size="17"><b>Liquid#: </b></font> Used to identify this liquid for others. Useful for coding your map.
    <font size="17"><b>Type: </b></font> Determines if the liquid is water, lava, etc.
    <font size="17"><b>Meshless: </b></font>Determines whether or not the liquid is visibe on all 6 faces, instead of just one face.]]
            },
        },
        _Gas = {
            _nameStub = "_Gas",
...
<font size="17"><font color = "rgb(0, 143, 156)"></font><b>Water: </b></font> -8 oxygen/sec
<font size="17"><font color = "rgb(0, 255, 0)"></font><b>Acid: </b></font> -30 oxygen/sec
<font size="17"><font color = "rgb(255, 0, 0)"></font><b>Lava: </b></font> Instant death
...
Metadata:
    <font size="17"><b>Button# & Path#: </b></font>Allows you to determine the order in which buttons can be pressed. Letters after the button number allow you to have buttons that split into many different paths. Example: 5, 6, '5A', '6A'.
    <font size="17"><b>Group: </b></font>Determines whether or not said button is a group button. Group buttons require 50% of all players in the map to press.
    <font size="17"><b>Inactive Color: </b></font>Overrides the inactive color specified in map settings for this button. Leave empty for default.
    <font size="17"><b>Active Color: </b></font>Overrides the active color specified in map settings for this button. Leave empty for default.
    <font size="17"><b>Activated Color: </b></font>Overrides the activated color specified in map settings for this button. Leave empty for default.
    <font size="17"><b>Activated Sound: </b></font>Overrides the activated sound specified in map settings for this button. Leave empty for default.
    <font size="17"><b>LocatorImage: </b></font>Overrides the locator image specified in map settings for this button. Leave empty for default.]]
            },
        },
        Detail = {
...
Metadata:
    <font size="17"><b>Momentum: </b></font>Determines whether or not you continue moving in the direction that you exited the zipline.
    <font size="17"><b>Jumpable: </b></font>Allows players to jump off ziplines mid zipline.
    <font size="17"><b>Color: </b></font>The color of the zipline.
    <font size="17"><b>Material: </b></font>The material of the zipline.
    <font size="17"><b>Zipline Width: </b></font>The width & height of the zipline cable.
    <font size="17"><b>Sparkle: </b></font>Determines if a sparkle particle will play where the player 'grabs' onto the zipline.]]
            },
        },
        _Kill = {
...
Metadata:
    <font size="17"><b>Oxygen: </b></font>The amount of oxygen the player will obtain on collection of the tank.]]
            },
        },
        _SpeedBooster = {
...
Metadata:
    <font size="17"><b>WalkSpeed: </b></font>The speed the players WalkSpeed will be set to.]]
            },
        },
        _JumpBooster = {
...
Metadata:
    <font size="17"><b>JumpPower: </b></font>The power the players JumpPower will be set to.]]
            },
        },
    },
    addonTags = {
...
Metadata:
    <font size="17"><b>TeleportNumber: </b></font>Determines which teleporters are linked together. There can only be one start and one end.
    <font size="17"><b>TeleportType: </b></font>Determines if its the start or the end of a link.
    <font size="17"><b>DoFlash: </b></font>Determines if the players screen will flash when telepored with the given color and duration.
    <font size="17"><b>FlashColor: </b></font>Determines the color of the flash that will play if DoFlash is true.
    <font size="17"><b>FlashDuration: </b></font>Determines the length of the flash if DoFlash is true.]]
            },
        },
        _Waterjet = {
            _nameStub = "_Waterjet",
...
Metadata:
    <font size="17"><b>FanNumber: </b></font>A unique identifier for the fan in use of scripting.
    <font size="17"><b>FanSpeed: </b></font>Speed in studs/sec that the fan will push players inside its bounds.
    <font size="17"><b>Distance: </b></font>The total distance that the fan can push you.
    <font size="17"><b>LinearMovement: </b></font>When true, the fans push players at a constant rate throughout the entire distance. When false, the rate that the fan pushes players decreases as you get farther away.
    <font size="17"><b>FanShape: </b></font>Determines if the bounds that the fan will push players in is a cylinder, or a box.
    <font size="17"><b>Enabled: </b></font>Determines whether the fan is currently active.
    <font size="17"><b>BubbleParticle: </b></font>The number of the ImageID that the fan's particles will show. 
]]
            },
        },
    }
