...
## [1.3.3] - 2026/07/10
### Changed
- Selecting a map with the plugin now automatically Un-Sandboxes all instanes in the map. Fixes the error `The current thread cannot require 'Runtime' since 'Runtime' has the Sandboxed property set to false but the calling thread is sandboxed`.
