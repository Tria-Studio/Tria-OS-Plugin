    ...
    Addons = {
        {
            ...
            InsertFunction = function()
                ...
                local recording = ChangeHistoryService:TryBeginRecording("insertPluginAddon", string.format('Inserted map addon "%s"', "TUNE"))
                if recording then
...
task.spawn(function()
    ...
    pcall(Tune.Init, Tune, true, true)
            ...
            InsertFunction = function()
                ...
                local recording = ChangeHistoryService:TryBeginRecording("insertPluginAddon", string.format('Inserted map addon "%s"', "Waterjets"))
                if recording then
            ...
            InsertFunction = function()
                local recording = ChangeHistoryService:TryBeginRecording("insertPluginComponent", string.format('Inserted map addon "%s"', "MeshKit"))
                if recording then
